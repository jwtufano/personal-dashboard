    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_created_date', models.DateTimeField(default=datetime.datetime(2020, 4, 15, 10, 33, 20, 468897))),
                ('task_due_date', models.DateTimeField(default=datetime.datetime(2020, 4, 15, 10, 33, 20, 468918))),
