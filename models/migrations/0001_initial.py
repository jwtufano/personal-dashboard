    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_created_date', models.DateTimeField(default=datetime.datetime(2020, 4, 15, 2, 24, 4, 266642))),
                ('task_due_date', models.DateTimeField(default=datetime.datetime(2020, 4, 15, 2, 24, 4, 266662))),
