    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_created_date', models.DateTimeField(default=datetime.datetime(2020, 4, 15, 1, 38, 2, 43624))),
                ('task_due_date', models.DateTimeField(default=datetime.datetime(2020, 4, 15, 1, 38, 2, 43646))),
