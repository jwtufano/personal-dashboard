    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_created_date', models.DateTimeField(default=datetime.datetime(2020, 4, 15, 10, 34, 2, 923780))),
                ('task_due_date', models.DateTimeField(default=datetime.datetime(2020, 4, 15, 10, 34, 2, 923803))),
